    ...
    <section className="py-20 px-4">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {/* starter plan */}
          <div className="bg-whitep-8 rounded-lg shadow-lg">
        ...
        <div className='text-center mt-12'>
            ...
            <button className='bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors cursor-pointer'>Get Started</button>
        </div>
      </div>
    </section>
  );
