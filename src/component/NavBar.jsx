...
const NavBar = () => {
  ...
  return (
    ...
    >
      {/* NavBar container */}
      <nav className="container flex w-full mx-auto items-center justify-between px-4 sm:px-6 lg:px-8 md:h-20 h-16">
        {/* Logo */}
        ...
        {/* mobile menu button(hamburger icon) for navigation */}
