...
const NewsLetterSection = () => {
    return ( 
        ...
        className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="bg-blue-600 rounded-2xl overflow-hidden items-center ">
                <div className="relative md:px-16 px-6 py-16 md:py-24">
                    {/* gradient bg name the container clip-path then browse clippath and edit  any shape, copy n paste it in the index.CSS*/}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-0">
                        ...
                        <button className="w-full sm:w-auto cursor-pointer bg-green-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-l-none sm:rounded-r-lg flex items-center gap-2 text-center">
